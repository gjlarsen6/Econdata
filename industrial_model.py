...
SOURCE_CONFIG: dict[str, dict] = {
    ...
    "ism_pmi": {
        ...
        "group_name":   "Manufacturing Orders Leading Indicators",
        "label_map": {
            "NEWORDER":   "New Orders: Nondefense Capital Goods",
            "DGORDER":    "New Orders: Durable Goods",
            "AMTUNO":     "Unfilled Orders: Total Mfg",
            "MNFCTRIRSA": "New Orders: Total Mfg (SA)",
        },
    ...
    "capacity_util_sector": {
        ...
        "label_map": {
            ...
            "CAPUTLG331S": "Capacity Util: Primary Metals",
        },
